                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            _infoCard(Icons.water_drop, "Today's Usage",
                                "50 Gallons"),
                            _infoCard(
                                Icons.favorite, "My Donations", "2 Donations"),
                          ],
                        ),
                        const SizedBox(height: 10),
                        Row(
                          ...
                          children: [
                            _infoCard(
                                Icons.handshake, "My Requests", "2 Supplies"),
                            _infoCard(Icons.shower, "My Goals", "10min Shower"),
                          ],
                        ),
                        const SizedBox(height: 20),
                        const Text(
