...
class RequestDetailsPage extends StatefulWidget {
  ...
  const RequestDetailsPage({Key? key, required this.requestData, required this.requestId}) : super(key: key);
...
class _RequestDetailsPageState extends State<RequestDetailsPage> {
  ...
  LatLng _selectedLocation = LatLng(0, 0); // Initialize with default coordinates
  ...
  void initState() {
    ...
    _contactController = TextEditingController(text: widget.requestData['contact']);
    _addressController = TextEditingController(text: widget.requestData['address']);
    _descriptionController = TextEditingController(text: widget.requestData['description']);
    _selectedUrgencyLevel = widget.requestData['urgencyLevel'] ?? _selectedUrgencyLevel;
    _selectedWaterType = widget.requestData['waterType'] ?? _selectedWaterType;
    _locationController = TextEditingController(text: widget.requestData['location']['locationName']);
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context) =>  RequestsListPage()), // Navigate to the request list page
    ...
    try {
      ...
      if (locations.isNotEmpty) {
        ...
        setState(() {
          ...
          _mapController.animateCamera(CameraUpdate.newLatLng(_selectedLocation)); // Move map camera
  ...
  Widget build(BuildContext context) {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/Home_Screen.png'), // Replace with your image path
                fit: BoxFit.cover,
              ),
            ),
          ),
          ...
          children: [
            TextFormField(
              ...
              decoration:  InputDecoration(
                              ...
                              prefixIcon: const Icon(Icons.person, color: Color(0xFF03045E)),
                              filled: true,
            ...
            TextFormField(
              ...
              decoration:  InputDecoration(
               hintText: "Enter your address",
                              prefixIcon: const Icon(Icons.location_city, color: Color(0xFF03045E)),
                              filled: true,
                              fillColor: const Color(0xffCAF0F8),
                              border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
            ...
            DropdownButtonFormField<String>(
              ...
              decoration:  InputDecoration(
                hintText: "Select water type",
                              prefixIcon: const Icon(Icons.water_drop, color: Color(0xFF03045E)),
                              filled: true,
                              fillColor: const Color(0xffCAF0F8),
                              border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
               hintText: "Enter description",
                              prefixIcon: const Icon(Icons.description, color: Color(0xFF03045E)),
                              filled: true,
                              fillColor: const Color(0xffCAF0F8),
                              border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
            ...
            DropdownButtonFormField<String>(
              ...
              decoration:  InputDecoration(
                hintText: "Select urgency level",
                              prefixIcon: const Icon(Icons.priority_high_rounded, color: Color(0xFF03045E)),
                              filled: true,
                              fillColor: const Color(0xffCAF0F8),
                              border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                hintText: "Enter Location",
                              prefixIcon: const Icon(Icons.location_on, color: Color(0xFF03045E)),
                              filled: true,
                              fillColor: const Color(0xffCAF0F8),
                              border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
    ...
    padding: const EdgeInsets.symmetric(horizontal: 40, vertical: 15),
      ...
      fontSize: 16, // Button text size
            ...
            Container(
              ...
              child: GoogleMap(
                onMapCreated: (GoogleMapController controller) {
                  ...
                  _mapController.moveCamera(CameraUpdate.newLatLng(_selectedLocation)); // Move camera to selected location
                },
                ...
                onTap: (LatLng position) {
                  setState(() {
                    ...
                    _locationController.text = "Selected location"; // Update the location text
                  });
                },
              ),
            ),
           ...
           const SizedBox(height: 16),
Row(
  mainAxisAlignment: MainAxisAlignment.spaceBetween, // Adjusts the space between buttons
  children: [
    // Update Button
    ElevatedButton(
      style: ElevatedButton.styleFrom(
