...
class TimelinePage extends StatefulWidget {
  ...
  const TimelinePage({Key? key, required this.requestId, required this.requestData}) : super(key: key);
...
class _TimelinePageState extends State<TimelinePage> {
  ...
  List<Map<String, String>> timelineStages = [
    {'title': 'Submitted', 'description': 'Your request has been submitted and is under review.'},
    {'title': 'Approved', 'description': 'Your request has been approved.'},
    {'title': 'Donated', 'description': 'The water supply has been donated to you.'},
    {'title': 'Completed', 'description': 'Your request has been successfully completed.'},
  ];
  ...
  void initState() {
    super.initState();
    currentStage = widget.requestData['status'] ?? 'Submitted'; // Get current status of the request
  }
  ...
  Widget build(BuildContext context) {
    bool isCompleted = currentStage == 'Completed'; // Check if the request is completed
       ...
       SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                children: List.generate(timelineStages.length, (index) {
                  ...
                  bool isActive = isCompleted || 
                                  timelineStages[index]['title'] == currentStage || 
                                  timelineStages.indexWhere((stage) => stage['title'] == currentStage) > index;
                      ...
                      Column(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color: isActive ? Color(0xFF03045E) : Colors.grey,
                            ),
                            child: const Icon(
                              Icons.cloud,
                              color: Colors.white,
                          ...
                          if (index < timelineStages.length - 1)
                            Container(
                              width: 2,
                              height: 40,  // Height for the line between stages
                              color: isActive ? Color(0xFF03045E) : Colors.grey,
                            ),
                        ],
                      ),
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                               ...
                               fontWeight: FontWeight.w800,
                              fontFamily: 'Baloo 2',
                                color: isActive ? Color(0xFF03045E) : Colors.black,
                              ),
                            ),
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.center,  // Centering buttons
              children: [
    ...
    child: Row(
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: Color(0xFF03045E), // Circle color (you can change this)
          ),
