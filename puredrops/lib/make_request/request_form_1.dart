...
class _RequestForm1State extends State<RequestForm1> {
  ...
  decoration: InputDecoration(
    ...
    hintText: "Enter your email", // Optional, if you want a hint text
     prefixIcon: const Icon(Icons.email, color: Color(0xFF03045E)),// Optional icon for email
    filled: true,
    fillColor: const Color(0xffCAF0F8),
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(30),
...
const SizedBox(height: 20),
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: "Enter your contact no", // Optional, if you want a hint text
     prefixIcon: const Icon(Icons.phone, color: Color(0xFF03045E)),// Optional icon for email
    filled: true,
    fillColor: const Color(0xffCAF0F8),
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(30),
      ...
      return 'Please enter a valid 10-digit contact number';
                          ...
                          TextFormField(
                            ...
                            decoration:  InputDecoration(
                              hintText: "Enter your address", // Optional, if you want a hint text
     prefixIcon: const Icon(Icons.location_city, color: Color(0xFF03045E)),// Optional icon for email
    filled: true,
    fillColor: const Color(0xffCAF0F8),
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(30),
      borderSide: BorderSide.none,
                ...
                value: _waterType,
                decoration:  InputDecoration(
                  hintText: "Enter type of water", // Optional, if you want a hint text
     prefixIcon: const Icon(Icons.water_drop, color: Color(0xFF03045E)),// Optional icon for email
    filled: true,
    fillColor: const Color(0xffCAF0F8),
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(30),
      borderSide: BorderSide.none,
                ...
                items: const [
                  DropdownMenuItem(child: Text('Drinking'), value: 'Drinking'),
                  DropdownMenuItem(child: Text('Agriculture'), value: 'Agriculture'),
                  DropdownMenuItem(child: Text('Sanitation'), value: 'Sanitation'),
                ],
                onChanged: (value) {
                  setState(() {
                    _waterType = value!;
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => RequestForm2(
            ...
            email: _emailController.text,
            contact: _contactController.text,
            address: _addressController.text, // Added address here
            waterType: _waterType,
          ),
        ),
      );
