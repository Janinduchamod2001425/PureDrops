...
class _RequestForm3State extends State<RequestForm3> {
  ...
  LatLng _selectedLocation = const LatLng(6.9271, 79.8612); // Default position (Colombo)
  late GoogleMapController _mapController;
  final TextEditingController _locationController = TextEditingController(); // Text field controller
 ...
 // Show confirmation dialog
  ...
  Widget build(BuildContext context) {
    ...
    border: OutlineInputBorder(
      ...
      borderSide: BorderSide.none,
                 ...
                 prefixIcon: IconButton(
                  icon: const Icon(Icons.search, color: Color(0xFF03045E)),
                  onPressed: _searchLocation, // Search when button pressed
                ),
              ),
            ),
          ),
    ...
    padding: const EdgeInsets.symmetric(horizontal: 40, vertical: 15),
            ...
            onPressed: _saveRequestDetails, // Save data when button pressed
            child: const Text(
              'Submit Request',
              style: TextStyle(
