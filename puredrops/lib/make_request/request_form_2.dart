...
class _RequestForm2State extends State<RequestForm2> {
            ...
            children: [
              TextFormField(
                ...
                decoration:  InputDecoration(
                  hintText: "Enter descrption", // Optional, if you want a hint text
     prefixIcon: const Icon(Icons.description, color: Color(0xFF03045E)),// Optional icon for email
    filled: true,
    ...
    border: OutlineInputBorder(
      ...
      borderSide: BorderSide.none,
             ...
             const SizedBox(height: 10),
              ...
              Container(
  decoration: BoxDecoration(
   color: Colors.white,// White background for the entire box
  ...
  child: Column(
    children: [
     const  Align(
  alignment: Alignment.centerLeft, // Adjust alignment as needed (e.g., Alignment.centerRight or Alignment.center)
  child: Text(
    'Urgency Level',
    style: TextStyle(
      fontSize: 20,
     ...
     // The water level control row
      Row(
        ...
        children: [
         ...
         const  SizedBox(width: 10), // Space between button and glass
          Container(
            width: 85, // Width of the glass
            height: 300, // Height of the glass
            decoration: BoxDecoration(
              color: Colors.white, // White background for the glass
              border: Border.all(
                color: Colors.white, // Blue border for the glass
                width: 1, // Border thickness
              ),
              borderRadius: BorderRadius.circular(16), // Rounded glass edges
              boxShadow: [
                BoxShadow(
                  color: Colors.blueGrey.withOpacity(0.3), // Subtle shadow for depth
                  blurRadius: 12, // Softer shadow
                  spreadRadius: 4,
                  offset: Offset(0, 8), // Slight shadow offset
                ),
              ],
            ),
            child: Stack(
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  height: (320 / (maxLevel + 1)) * (_currentLevel + 1), // Dynamic height for water level
                  decoration: const BoxDecoration(
                    color: Color.fromARGB(255, 108, 216, 238),// Solid blue color for the water
                    borderRadius: BorderRadius.only(
                      topLeft: Radius.circular(12), // Smooth corners for the water level
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Icon(
                          Icons.bubble_chart,
                          size: 30,
                          color: Colors.white.withOpacity(0.8), // White bubble
                        ),
                      ),
                      Positioned(
                        top: 70,
                        child: Icon(
                          Icons.bubble_chart,
                          size: 24,
                          color: Colors.white.withOpacity(0.7), // Another white bubble
                        ),
                      ),
                      Positioned(
                        top: 120,
                        child: Icon(
                          Icons.bubble_chart,
                          size: 18,
                          color: Colors.white.withOpacity(0.6), // Smaller white bubble
                        ),
                      ),
                    ],
                  ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        Colors.white.withOpacity(0.1), // Transparent white overlay
                        Colors.white.withOpacity(0.2),
                      ],
                      begin: Alignment.topCenter,
                      end: Alignment.bottomCenter,
                    ),
                    borderRadius: BorderRadius.circular(16), // Matching the outer glass radius
                  ),
                ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Colors.white.withOpacity(0.5), // White highlight for reflection
                          Colors.transparent,
                        ],
                        begin: Alignment.topCenter,
                        end: Alignment.bottomCenter,
          ...
          SizedBox(width: 10), // Space between glass and button
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFF03045E),
            ),
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (_user != null) {
                      try {
                        ...
                        await _firestore.collection('requests_temp').add({
                          'name': widget.name,
                          'email': widget.email,
                          ...
                          'urgencyLevel': urgencyLevels[_currentLevel], // Save the urgency level as a string
                          'userId': _user!.uid, // Store user ID in the request
                        });
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => RequestForm3(
                              ...
                              waterType: widget.waterType,
                              description: _descriptionController.text,
                              urgencyLevel: urgencyLevels[_currentLevel], // Pass urgency level
                            ),
                          ),
                        );
                      } catch (e) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('User not authenticated. Please log in to continue.')),
                      );
                    }
                  }
                },
