...
class WaterIntakeForm extends StatefulWidget {
  @override
  _WaterIntakeFormState createState() => _WaterIntakeFormState();
}

class _WaterIntakeFormState extends State<WaterIntakeForm> {
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => WaterIntakeList()),
        );
      } catch (e) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != DateTime.now()) {
      setState(() {
        _dateController.text = picked.toLocal().toString().split(' ')[0]; // Format: YYYY-MM-DD
      });
    }
  }
