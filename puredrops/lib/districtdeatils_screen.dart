...
class _DistrictdetailsScreenState extends State<DistrictdetailsScreen> {
  ...
  {'name': 'Anuradhapura District ', 'image': 'assets/district/Anuradhapura.jpg', 'resources': '• Total water Needs - 750 households\n• Water Availbility - 60% \n• Water Quelity Status - High' },
    {'name': 'Polonnaruwa District', 'image': 'assets/district/Polonnaruwa.jpg', 'resources': '• Total water Needs - 120 households\n• Water Availbility - 80% \n• Water Quelity Status - Moderate' },
    {'name': 'Moneragala District', 'image': 'assets/district/Moneragala.jpg', 'resources': '• Total water Needs - 550 households\n• Water Availbility - 60% \n• Water Quelity Status - High' },
    {'name': 'Ampara District', 'image': 'assets/district/Ampara.jpg', 'resources': '• Total water Needs - 400 households\n• Water Availbility - 60% \n• Water Quelity Status - High' },
    {'name': 'Batticaloa District', 'image': 'assets/district/Batticaloa.jpg', 'resources': '• Total water Needs - 400 households\n• Water Availbility - 70% \n• Water Quelity Status - Moderate' },
    {'name': 'Trincomalee District', 'image': 'assets/district/Trincomalee.jpg', 'resources': '• Total water Needs - 300 households\n• Water Availbility - 72% \n• Water Quelity Status - High' },
    {'name': 'Hambantota District', 'image': 'assets/district/Hambantota.jpg', 'resources': '• Total water Needs - 350 households\n• Water Availbility - 73% \n• Water Quelity Status - Moderate' },
    {'name': 'Puttalam District', 'image': 'assets/district/Puttalam.jpg', 'resources':'• Total water Needs - 750 households\n• Water Availbility - 74% \n• Water Quelity Status - High' },
    {'name': 'Nuwara Eliya District', 'image': 'assets/district/Nuwara Eliya.jpg', 'resources': '• Total water Needs - 750 households\n• Water Availbility - 75% \n• Water Quelity Status - Moderate' },
    {'name': 'Badulla District', 'image': 'assets/district/Badulla.jpg', 'resources': '• Total water Needs -600 households\n• Water Availbility - 78% \n• Water Quelity Status - Moderate' },
    {'name': 'Mannar District', 'image': 'assets/district/Mannar.jpg', 'resources': '• Total water Needs - 200 households\n• Water Availbility - 78% \n• Water Quelity Status - Moderate' },
    {'name': 'Ratnapura District', 'image': 'assets/district/Ratnapura.jpg', 'resources': '• Total water Needs - 100 households\n• Water Availbility - 79% \n• Water Quelity Status - Moderate' },
  ];
  ...
  List<Map<String, String>> get filteredDistricts {
    if (_searchText.isEmpty) {
      ...
      return districts
          .where((district) => district['name']!.toLowerCase().contains(_searchText.toLowerCase()))
          .toList();
    }
  }
  ...
  Widget _buildDistrictCard(BuildContext context, String districtName, String imagePath, String resourceDetails) {
    return Card(
      elevation: 4.0,
  ...
  void _navigateToDistrictPage(BuildContext context, String districtName) {
    if (districtName.contains('Anuradhapura')) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const DistrictMoreDetailsPage()),
      );
